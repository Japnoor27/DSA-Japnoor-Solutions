<h2><a href="https://leetcode.com/problems/maximum-population-year/description/">1983. Maximum Population Year</a></h2><h3>Easy</h3><hr><p>You are given a 2D integer array <code>logs</code> where each <code>logs[i] = [birth<sub>i</sub>, death<sub>i</sub>]</code> indicates the birth and death years of the <code>i<sup>th</sup></code> person.</p>
